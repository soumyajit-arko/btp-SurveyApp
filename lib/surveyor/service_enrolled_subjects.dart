...
class ServiceEnrolledPage extends StatefulWidget {
  final String nextPage;
  final FormDetails formDetails;
  const ServiceEnrolledPage({required this.nextPage,required this.formDetails, super.key});
  @override
  _ServiceEnrolledPageState createState() => _ServiceEnrolledPageState();
}

class _ServiceEnrolledPageState extends State<ServiceEnrolledPage> {
  ...
  Future<void> loadFamilyDetails() async {
    ...
    final familyDetails = await dbHelper.getSubjectsValidForService(widget.formDetails.formName);
